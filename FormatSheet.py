...
def RegCorDescShift():
    ...
    page="<style>#cortab{margin-top: 25px;}#left{float:left; width:15%; background-color:blue}#right{float:right; width:15%; background-color:red}</style><html><div id='left'><img src='http://digitalroomfileshare.cloud/static/selectedFrame.png'></div><div id='right'><img src='http://digitalroomfileshare.cloud/static/heatmap.png'></div><div id='cortab'>"+relations.to_html()+"</div></html>"
