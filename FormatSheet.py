...
def RegCorDescShift():
    ...
    page="<html><header><style>th{background-color:blue; color:white;}tr:nth-child(even){background-color:blue; color:white;}#title{text-align:center; font-weight:bold; font-size:20px; margin-bottom:50px; padding-top:80px;}#cortab{margin-top: 25px;}#right{float:right; width:15%; background-color:blue;}#left{float:left; width:15%; background-color:red;}</style></header><div id='title'>Statistical Overview</div><div id='title'>"+lorem0+"</div><div id='title'>"+lorem1+"<img src='http://digitalroomfileshare.cloud/static/selectedFrame.png'></div><div><img src='http://digitalroomfileshare.cloud/static/heatmap.png'></div><div><div id='title'>"+DescriptiveTableTB+"</div><div id='title'>"+lorem4+"</div><div id='cortab'>"+relations+"</div></html>"
